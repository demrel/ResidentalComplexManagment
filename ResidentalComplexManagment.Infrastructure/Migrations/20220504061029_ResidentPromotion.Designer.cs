...
namespace ResidentalComplexManagment.Infrastructure.Migrations
{
    ...
    [Migration("20220504061029_ResidentPromotion")]
    partial class ResidentPromotion
    {
            ...
            modelBuilder.Entity("ResidentalComplexManagment.Domain.Entities.Accountment.ResidentDebtItem", b =>
                {
                    ...
                    b.HasKey("ResidentId", "PaymentItemId");

                    b.ToTable("ResidentDebtItems");
                });

            modelBuilder.Entity("ResidentalComplexManagment.Domain.Entities.Accountment.ResidentDebtItemDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ResidentDebtItemDiscount");
                });
            ...
            modelBuilder.Entity("ResidentalComplexManagment.Core.Entities.Users.Resident", b =>
                {
                    ...
                    b.Navigation("ResidentDiscounts");
                });
